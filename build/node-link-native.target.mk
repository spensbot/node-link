...
TOOLSET := target
TARGET := node-link-native
DEFS_Debug := \
	'-DNODE_GYP_MODULE_NAME=node-link-native' \
	'-DUSING_UV_SHARED=1' \
	'-DUSING_V8_SHARED=1' \
...
OBJS := \
	$(obj).target/$(TARGET)/src/node_link.o
...
$(builddir)/node-link-native.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/node-link-native.node: LIBS := $(LIBS)
$(builddir)/node-link-native.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/node-link-native.node: TOOLSET := $(TOOLSET)
$(builddir)/node-link-native.node: $(OBJS) $(builddir)/nothing.a FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/node-link-native.node
# Add target alias
.PHONY: node-link-native
node-link-native: $(builddir)/node-link-native.node

# Short alias for building this executable.
.PHONY: node-link-native.node
node-link-native.node: $(builddir)/node-link-native.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/node-link-native.node
